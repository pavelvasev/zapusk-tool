...
module DasParamsComputeInsert
  ...
  def compute_params( params, extra_know, error_msg_context,testmask=nil )
    if params["params"]
      ...
      other_trash = {"hilevel"=>true, "_component_name"=>"papapdf", "type"=>"papapdf", "parent_global_name"=>"vasev", "component_global_name"=>"vasev-papapdf", "stack_of_types_dirs"=>"/zapusk/vasev.zdb"}
